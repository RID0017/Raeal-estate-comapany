...
tal.position.set(0,-1.39,0)
tal.rotation.set(0,-4.53,0)
 scene.add(tal)
//    gui.add(tal.position, 'z').min(- 27).max(1).step(0.01).name('positonZ')
   gui.add(tal.position, 'y').min(- 30).max(2).step(0.01).name('positonY')
...
tll.rotation.set(-0.365,0,-0.092)
   ...
   if(window.innerWidth>=1200)
   {
    ...
    {
     tll.scale.set(.8,.8,.8)
     tll.position.set(0,-20.612,-10)
    }
     if(window.innerWidth>=768)
    {
     tll.scale.set(.8,.8,.8)
     tll.position.set(0,-20.104,0)
    }
     if(window.innerWidth>=600)
    {
     tll.scale.set(.6,.6,.6)
    ...
    {
     tll.scale.set(.5,.5,.5)
     tll.position.set(0,-21,0)
    }
     if(window.innerWidth>=200)
    {
     tll.scale.set(.4,.4,.4)
     tll.position.set(0,-20.608,0)
    }
   }
